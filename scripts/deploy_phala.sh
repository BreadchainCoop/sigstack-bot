...
echo ""
echo "Site Message button: after first register / username ensure (or re-register),"
echo "  phala logs --cvm-id $CVM_ID"
echo "Find 'Signal username ready' username_link, set GH Actions var"
echo "PUBLIC_SIGNAL_USERNAME_LINK, redeploy Pages."
echo "See .agents/docs/DEVELOPMENT.md#signal-username-site-message-button"
